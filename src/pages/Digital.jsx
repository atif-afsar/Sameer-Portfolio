...
export default function Digital() {
  return (
    <section id="digital" className="min-h-screen bg-[#efefef] overflow-hidden">
      <div className="relative min-h-screen mx-auto w-full max-w-[1320px] px-4 sm:px-6 lg:px-10 pt-20 sm:pt-24 lg:pt-20 pb-10 sm:pb-12 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10">
        ...
        <div className="flex flex-col justify-center pl-0 lg:pl-10 order-2">
          ...
          >
            Crafting data-driven campaigns that convert audiences
            <span className="hidden sm:inline">
              <br />
            </span>
            into communities. Specializing in social media strategy,
            <span className="hidden sm:inline">
              <br />
            </span>
            content marketing, and brand growth optimization.
          </motion.p>
          <motion.p
            {...fadeUp(0.4)}
